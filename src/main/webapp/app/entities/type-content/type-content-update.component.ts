...
export class TypeContentUpdateComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.activatedRoute.data.subscribe(({ typeContent }) => {
            ...
            this.createdDate = this.typeContent.createdDate != null ? this.typeContent.createdDate.format(DATE_TIME_FORMAT) : null;
            this.updatedDate = this.typeContent.updatedDate != null ? this.typeContent.updatedDate.format(DATE_TIME_FORMAT) : null;
        });
    }
    ...
    save() {
        this.isSaving = true;
        this.typeContent.createdDate = this.createdDate != null ? moment(this.createdDate, DATE_TIME_FORMAT) : null;
        this.typeContent.updatedDate = this.updatedDate != null ? moment(this.updatedDate, DATE_TIME_FORMAT) : null;
